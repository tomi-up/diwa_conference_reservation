<?php
/**
 * Reservation Rejected Email Template (Mobile & Dark-Mode Optimized)
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Conference Room Reservation – Unavailable</title>
</head>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #cbd5e1; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
        ...
        <tr>
            <td align="center" style="background-color: #ffffff; padding: 25px 20px; text-align: center; border-top: 5px solid #951a1d; border-bottom: 1px solid #e2e8f0;">
                ...
                <h2 style="margin: 16px 0 0 0; font-size: 20px; font-weight: 700; color: #951a1d; letter-spacing: -0.3px;">Conference Room Reservation &ndash; Unavailable</h2>
            </td>
        </tr>
        <tr>
            <td style="padding: 25px 20px;">
                <p style="font-size: 15px; margin-bottom: 15px; color: #334155;">Dear <strong>{{ requester_name }}</strong>,</p>
                <p style="margin-bottom: 20px; font-size: 15px; color: #334155;">Unfortunately, your requested conference room schedule is unavailable.</p>
                ...
                <div style="background-color: #fdf2f2; border: 1px solid #fecaca; border-left: 5px solid #951a1d; padding: 18px 20px; margin: 20px 0; border-radius: 6px;">
                    <h3 style="margin-top: 0; margin-bottom: 12px; color: #951a1d; font-size: 16px; font-weight: 700; border-bottom: 1px dashed #fca5a5; padding-bottom: 6px;">Requested Schedule</h3>
                    <table width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size: 14px;">
                        <tr>
                            <td width="38%" style="color: #7f1d1d; font-weight: 700; padding: 4px 0;">Facility:</td>
                        ...
                        <tr>
                            <td style="color: #7f1d1d; font-weight: 700; padding: 6px 0 0 0;">Reason:</td>
                            <td style="color: #951a1d; font-weight: 700; padding: 6px 0 0 0;">{{ rejection_reason }}</td>
                        </tr>
                    </table>
                </div>

                <p style="font-size: 14px; color: #475569;">Please select another available schedule or contact DIWA Center Conference Services for assistance.</p>
